export const enUI = {
    ...
    skinsTooltip: 'Current Skin: {name}',
    wardrobeTooltip: 'Wardrobe',
    relicsTooltip: 'Relics & Biomes',
    optionsTooltip: 'Settings',
    ...
    // Top Actions & Utility
    trialsBtn: 'Trials',
    hyperdriveTooltip: 'Hyperdrive (2x Speed)',
